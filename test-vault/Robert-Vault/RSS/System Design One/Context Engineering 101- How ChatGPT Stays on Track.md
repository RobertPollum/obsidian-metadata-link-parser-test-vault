...
link: https://newsletter.systemdesign.one/p/what-is-context-engineering
author: Neo Kim
publish_date: 2025-12-19 05:30:29
saved_date: 2026-01-17 15:10:03
image: https://substack-post-media.s3.amazonaws.com/public/images/8c119e5c-4c64-4474-ad41-692b9badd57a_1280x720.png
tags: 
---
...
-   _[Share this post](https://newsletter.systemdesign.one/p/what-is-context-engineering/?action=share) & I'll send you some rewards for the referrals._
...
You rewrote your question, added “_think step by step,_” and maybe gave a bit more detail. Sometimes it helped. Sometimes it didn’t…
...
Instead of asking, “_How do I phrase this better?_”, you ask, “_What information should the model see right now?_”
...
## [Context is a system. Ours is the best. (Newsletter partner).](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)

[

![](https://substackcdn.com/image/fetch/$s_!u4Um!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F10f885cb-bcde-44c7-9b06-9c7fe452309d_1600x900.png)



](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)

Most AI tools treat context like “a few files + a prompt.”

[Augment Code’s Context Engine](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter) treats it like an engineering problem: retrieve the right dependencies, contracts, call paths, and history—then keep it fresh as your code changes.

Less drift. Less guessing. More ship.

[See Augment’s Context Engine](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)
...
![](https://substackcdn.com/image/fetch/$s_!-l1q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F51317335-9e16-430c-9319-261a5fedccd0_1050x604.png)



](https://substackcdn.com/image/fetch/$s_!-l1q!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F51317335-9e16-430c-9319-261a5fedccd0_1050x604.png)

_Everything the model sees when generating a response: system instructions, examples, tools, conversation history, and the current message—all compete for limited space._
...
![](https://substackcdn.com/image/fetch/$s_!-WrM!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e0ef293-a3c7-49ab-afbb-3f8cac35a88c_1600x954.png)



](https://substackcdn.com/image/fetch/$s_!-WrM!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e0ef293-a3c7-49ab-afbb-3f8cac35a88c_1600x954.png)

_Model performance degrades as the context grows. The sweet spot is finding the minimum high-value information needed—more context isn’t always better._
...
You have probably done this in ChatGPT without realizing it. If you say, “_Format it like this_,” and paste a sample answer, the model will usually follow the pattern.
...
For example, if you ask ChatGPT, “_What is the capital of France?_” and then ask, “_What is the population?_”, it can usually infer you still mean the capital you just discussed.
...
## [Stop stuffing the context window. (Newsletter partner).](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)

[

![](https://substackcdn.com/image/fetch/$s_!ujPM!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F899ede7f-be95-405f-a63f-01a36fe7eef7_1400x400.gif)



](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)

The trick isn’t more context—it’s the right context at the right step.

[Augment’s Context Engine](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter) curates and composes context for professional engineers working in real, messy systems—so your agent can reason about architecture, not just autocomplete a diff.

[Explore how it works](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)
...
![](https://substackcdn.com/image/fetch/$s_!ybpt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce7838a3-f42e-4ec5-af88-a9e81a156f0a_1272x1012.png)



](https://substackcdn.com/image/fetch/$s_!ybpt!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce7838a3-f42e-4ec5-af88-a9e81a156f0a_1272x1012.png)

_Loading upfront (left) retrieves chunks upfront based on the query. Just-in-time (right) retrieves as the model reasons—more precise, but more round-trips._
...
## [Your codebase is bigger than your IDE. (Newsletter partner).](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)

[

![](https://substackcdn.com/image/fetch/$s_!DABI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc3fa6951-5079-460d-a054-bc9a4e3a65e3_1300x305.png)
...
[Augment’s Context Engine](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter) is built to pull relevant context across that reality—so AI answers don’t collapse the moment you leave the file you have open.

[Get real context](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)
...
![](https://substackcdn.com/image/fetch/$s_!pdy_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb96d53d2-8ad8-4f48-bbae-0c63940bab00_1520x1028.png)



](https://substackcdn.com/image/fetch/$s_!pdy_!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb96d53d2-8ad8-4f48-bbae-0c63940bab00_1520x1028.png)

_When context fills up, compress what matters—key decisions, goals, and facts—while keeping recent messages verbatim. The result: a fresh context that preserves the essential state._
...
![](https://substackcdn.com/image/fetch/$s_!BiUs!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F63ab9928-1357-4153-9177-2b989698e930_1220x904.png)



](https://substackcdn.com/image/fetch/$s_!BiUs!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F63ab9928-1357-4153-9177-2b989698e930_1220x904.png)

_Sub-agents work in their own context windows, using tens of thousands of tokens, but only pass condensed summaries to the lead agent—keeping its context clean and focused._
...
![](https://substackcdn.com/image/fetch/$s_!p3Uu!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a9c3934-f3bc-4b6f-b8d5-7d34672a77f8_1600x1069.png)



](https://substackcdn.com/image/fetch/$s_!p3Uu!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a9c3934-f3bc-4b6f-b8d5-7d34672a77f8_1600x1069.png)

_Start simple and iterate. Test on small tasks first—if it works, scale up and test again. If it fails, diagnose the problem type and apply the targeted fix. Either way, loop back and keep testing until it works reliably._
...
### [Context engineering, operationalized. (Newsletter partner).](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)
...
If you like the idea of context engineering, you’ll like what Augment does in practice:

A dedicated [Context Engine](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter) that continuously grounds your AI in the code, relationships, and constraints that actually matter—without you playing prompt Tetris.

[Learn more](https://www.augmentcode.com/context-engine?utm_source=neokim&utm_medium=newsletter)
...
You are now 200,001+ readers strong, very close to 201k. Let’s try to get 201k readers by 21 December. Consider sharing this post with your friends and get rewards.
...
[Share](https://newsletter.systemdesign.one/p/what-is-context-engineering?utm_source=substack&utm_medium=email&utm_content=share&action=share)