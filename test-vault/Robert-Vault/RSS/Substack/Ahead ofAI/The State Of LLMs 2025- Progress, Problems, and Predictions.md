...
publish_date: 2025-12-30 07:22:26
saved_date: 2026-01-17 15:09:36
image: https://substack-post-media.s3.amazonaws.com/public/images/dfad3fc4-b195-4e7e-a6a7-7701b59ed57b_1394x918.png
tags: 
---
...
_Figure 1: A short response and a longer response including intermediate steps that is typically generated by reasoning models._
...
_Figure 2: Table from the [DeepSeek V3 paper](https://arxiv.org/abs/2412.19437) estimating the cost of training the 671B parameter DeepSeek V3 model._
...
_Figure 3: Table from the DeepSeek R1 paper’s_ [supplementary materials](https://static-content.springer.com/esm/art%3A10.1038%2Fs41586-025-09422-z/MediaObjects/41586_2025_9422_MOESM1_ESM.pdf) _estimating the cost of training the R1 model on top of DeepSeek V3._
...
Third, and most interestingly, the paper presented _Reinforcement Learning with Verifiable Rewards_ (RLVR) with the GRPO algorithm as a new (or at least modified) algorithmic approach for developing so-called reasoning models and improving LLMs during post-training.
...
_Figure 4: Broad overview of how / when reinforcement learning is applied. There are many details that I am skipping in this overview, but interested readers can read more in my [The State of Reinforcement Learning for LLM Reasoning](https://magazine.sebastianraschka.com/p/the-state-of-llm-reasoning-model-training) article._
...
_Figure 5: A simple example of a verifiable reward._
...
_Figure 6: Some of the focus areas of proprietary and open-weight LLM development over the years. Note that this is cumulative, meaning that RLHF + PPO, for example, is still relevant and being used. However, it’s no longer the most hotly discussed topic._
...
_Figure 8: A code-based introduction to [LoRA tutorial](https://github.com/rasbt/LLMs-from-scratch/blob/main/appendix-E/01_main-chapter-code/appendix-E.ipynb)_
...
_Figure 10: Small excerpt of the results from my from-scratch GRPO training code, which is [available on GitHub](https://github.com/rasbt/reasoning-from-scratch/tree/main/ch06/02_rlvr_grpo_scripts_original)_
...
_Figure 12: Annotated table from the [gpt-oss model card paper](https://arxiv.org/abs/2508.10925)._
...
_Figure 13: Annotated figure from the 2019 [Do ImageNet Classifiers Generalize to ImageNet?](https://arxiv.org/abs/1902.10811) paper._
...
_Figure 14: Example adding command line arguments to a training script using the prompt “Add argparse for all hyperparameter options to training-script.py”._
...
_Figure 15: A non-staged example where an LLM just helped me to find and fix an error in a previous article._
...
_Figure 21: Excerpt of Build A Reasoning Model (From Scratch), which is available in [early access](https://mng.bz/Nwr7)._
...
[Build A Reasoning Model (From Scratch)](https://mng.bz/Nwr7) is very hard work but I am thoroughly enjoying working on it! I hope you and other readers will find it useful similar to _Build A Large Language Model (From Scratch)_
...
Thanks so much for subscribing to my _Ahead of AI_ blog and for supporting my work this year. I really appreciate it. Your support makes this work feasible in a very real sense and allows me to keep spending the time needed to write, experiment, and think deeply about these topics!