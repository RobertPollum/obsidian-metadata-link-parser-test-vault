...
link: https://adevnadia.medium.com/react-server-components-do-they-really-improve-performance-7fb7a263e2dd?source=rss-bcdf0570e41c------2
author: Nadia Makarevich
publish_date: 2025-10-28 02:16:19
saved_date: 2026-01-17 15:09:47
image: https://cdn-images-1.medium.com/max/1024/1*1qjNnhZw4HZAAQIZH2CBiQ.png
tags: #frontend #web-development #reactjs #react #javascript
---

![image](https://cdn-images-1.medium.com/max/1024/1*1qjNnhZw4HZAAQIZH2CBiQ.png)

![](https://cdn-images-1.medium.com/max/1024/1*1qjNnhZw4HZAAQIZH2CBiQ.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*K-Mf9ZFeDRIPNMZI.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*NTpeHRIJ1l5_Q-Q4.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*OrsXffq4vnNQhyds.png)
...
<html lang="en">  
  <head>  
   ...
   <link rel="stylesheet" href="/assets/index-C26Og\_lN.css">  
  </head>  
  <body>  
    <div id="root"></div>  
  </body>  
...
![](https://cdn-images-1.medium.com/max/1024/0*L8-I1xuCC83SfsRN.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*flphBJgSS7sMNEJl.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*NxLlslKgjO1gcWOCKGeTkg.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*Y5nxnpOxXuYUfV_Q7G7_3Q.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*gxaBDB3Y209rpR7l1WKGlA.png)
...
6.  Open the website at [https://localhost/inbox](https://localhost/inbox)
7.  Measure!
...
![](https://cdn-images-1.medium.com/max/1024/0*xhzMVuXADKqAvhiG.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*cK9xz1FNBvOrLMlABFF7Rg.png)
...
const htmlWithData = \`  
  <script>window.\_\_SSR\_DATA\_\_ = ${JSON.stringify({  
    sidebar,  
    messages,  
  })}</script>  
  ${HTMLString}\`;

Now on the frontend, it will be available as window.\_\_SSR\_DATA\_\_.sidebar that we can read and pass around:
...
export default function App({ messages, sidebar }) {  
  ...
  const sidebarData =  
    typeof window === 'undefined'  
      ? sidebar  
      : window.\_\_SSR\_DATA\_\_?.sidebar;  
  const messagesData =  
    typeof window === 'undefined'  
      ? messages  
      : window.\_\_SSR\_DATA\_\_?.messages;  
...
![](https://cdn-images-1.medium.com/max/1024/0*sJ-LYZz2H0bdhXs5.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*RfUs4WLn180iP20iuJ-OrQ.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*EzgNX6hL8TJMdbEdIp3D1A.png)
...
8.  Open the website at [https://localhost/inbox](https://localhost/inbox)
...
![](https://cdn-images-1.medium.com/max/1024/0*6_018XOmR1yRu4Ed.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*cyGqT4WLG6sKJUUp.png)
...
const htmlWithData = \`  
  <script>window.\_\_REACT\_ELEMENTS\_\_ = ${JSON.stringify({  
    "type": "div",  
    "props": { "children": \[...\] }  
  })}</script>  
  ${HTMLString}\`;
...
<script>self.\_\_next\_f.push(\[1,"6:\[\\"$\\",\\"div\\",null,{\\"className\\":\\"w-full h-full flex flex-col lg:flex-row\\",\\"children\\":\[\\"$\\",\\"div\\",null,{\\"className\\":\\"flex flex-1 h-full overflow-y-auto flex..."  
</script>
...
![](https://cdn-images-1.medium.com/max/1024/1*KZ3PV_ZO9t9SZxSKApPM3g.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*SumDwyx_BQhXUlPX.png)
...
7.  Open the website at [https://localhost/inbox](https://localhost/inbox)
...
![](https://cdn-images-1.medium.com/max/1024/1*dhfu8XBZcYBYVoTz12LUzQ.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*GyhYaalgHCQj7luq2SHvlg.png)
...
![](https://cdn-images-1.medium.com/max/1024/0*qdzuCNyeozvqzS2d.png)
...
![](https://cdn-images-1.medium.com/max/838/0*mDztD6BYYSediFnV.png)
...
_Originally published at_ [_https://www.developerway.com_](https://www.developerway.com/posts/react-server-components-performance)_. The website has more articles like this._ 😉
...
![](https://medium.com/_/stat?event=post.clientViewed&referrerSource=full_rss&postId=7fb7a263e2dd)